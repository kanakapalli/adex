...
import 'package:adex_server/src/generated/adex_service/adex_model.dart' as _i4;
import 'dart:typed_data' as _i5;
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i6;
import 'package:adex_server/src/generated/greetings/greeting.dart' as _i7;
import 'package:adex_server/src/generated/protocol.dart';
import 'package:adex_server/src/generated/endpoints.dart';
...
class TestEndpoints {
  late final _AdexServiceEndpoint adexService;
...
class _InternalTestEndpoints extends TestEndpoints
  ...
  void initialize(
    ...
    adexService = _AdexServiceEndpoint(
      endpoints,
...
class _AdexServiceEndpoint {
  _AdexServiceEndpoint(
  ...
  _i3.Future<_i4.AdexModel> processVideoFromUrl(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'adexService',
            method: 'processVideoFromUrl',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'adexService',
          methodName: 'processVideoFromUrl',
  ...
  _i3.Future<_i4.AdexModel> processVideo(
    _i1.TestSessionBuilder sessionBuilder,
    _i5.ByteData video,
    String userPrompt, {
    String? whatDoesThisVideoContain,
  ...
  _i3.Future<_i4.AdexModel?> getProcessingStatus(
    _i1.TestSessionBuilder sessionBuilder,
    int adexModelId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          parameters: _i1.testObjectToJson({'adexModelId': adexModelId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
  ...
  _i3.Future<_i4.AdexModel?> getProcessingStatusByProcessingId(
    _i1.TestSessionBuilder sessionBuilder,
    String processingId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'adexService',
            method: 'getProcessingStatusByProcessingId',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'adexService',
          methodName: 'getProcessingStatusByProcessingId',
          parameters: _i1.testObjectToJson({'processingId': processingId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
  ...
  _i3.Future<List<_i4.AdexModel>> getAllAdexModels(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'adexService',
            method: 'getAllAdexModels',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'adexService',
          methodName: 'getAllAdexModels',
          parameters: _i1.testObjectToJson({}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i4.AdexModel>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
