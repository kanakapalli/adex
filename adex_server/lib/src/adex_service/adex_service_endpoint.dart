...
''';
    ...
    return _withRetry(
      ...
      () async {
        final url = 'https://$_location-aiplatform.googleapis.com/v1/projects/$_projectId/locations/$_location/publishers/google/models/gemini-3-flash-preview:generateContent';
