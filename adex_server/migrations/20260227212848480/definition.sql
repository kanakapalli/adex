...
--
-- Class AdexModel as table adex_models
--
...
--
-- Class VideoFrameEmbedding as table video_frame_embeddings
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('adex', '20260227212848480', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260227212848480', "timestamp" = now();
